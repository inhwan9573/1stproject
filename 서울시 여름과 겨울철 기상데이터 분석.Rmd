...
library(car)
```
다중공선성(vif)을 확인하고 값이 10이상인 변수를 제거한 뒤 단계적 선택법으로 회귀식을 추정하였습니다.
그 결과, 겨울평균최고기온을 종속변수로 한 회귀식이 가장 유의하다고 판단되었습니다.(셋째자리에서 반올림)
$$겨울평균최고기온 = -1.28(강수량) + 1.69(최소습도) + 1.03(일조시간) - 1.59(최대풍속)$$
다른 회귀식은 유의하지 않고 종속변수에 대한 설명력이 부족하여 제외하였습니다.
...
### 여름평균기온
```{r}
avg_summer_average <- (sum(as.numeric(summer$평균기온))/30)
summer %>%
  ggplot(aes(x=년도, y=평균기온, group=1)) +
  geom_line(color="red") +
...
### 여름평균최고기온
```{r}
avg_summer_average_max <- (sum(as.numeric(summer$평균최고기온))/30)
summer %>%
  ggplot(aes(x=년도, y=평균최고기온, group=1)) +
  geom_line(color="red") +
  geom_point(shape=24, color="black", fill="red", size=5) +
  theme_ipsum() +
...
### 여름평균극점최고기온
```{r}
avg_summer_average_pole_max <- (sum(as.numeric(summer$평균극점최고기온))/30)
summer %>%
  ggplot(aes(x=년도, y=평균극점최고기온, group=1)) +
  geom_line(color="red") +
  geom_point(shape=24, color="black", fill="red", size=5) +
  theme_ipsum() +
  geom_hline(yintercept = avg_summer_average_pole_max, linetype = 2, color = "grey35", size = 1) +
  labs(title = "서울시 여름(6월-8월) 평균극점최고기온",
       subtitle = "1998 - 2018",
       x = "년도", 
       y = "기온") + theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5 ))
```
...
### 여름극점최고기온
```{r}
avg_summer_pole_max <- (sum(as.numeric(summer$극점최고기온))/30)
summer %>%
  ggplot(aes(x=년도, y=극점최고기온, group=1)) +
  geom_line(color="red") +
  geom_point(shape=24, color="black", fill="red", size=5) +
  theme_ipsum() +
...
### 여름평균최저기온
```{r}
avg_summer_average_min <- (sum(as.numeric(summer$평균최저기온))/30)
summer %>%
  ggplot(aes(x=년도, y=평균최저기온, group=1)) +
  geom_line(color="red") +
  geom_point(shape=24, color="black", fill="red", size=5) +
  theme_ipsum() +
...
### 여름평균극점최저기온
```{r}
avg_summer_average_pole_min <- (sum(as.numeric(summer$평균극점최저기온))/30)
summer %>%
  ggplot(aes(x=년도, y=평균극점최저기온, group=1)) +
  geom_line(color="red") +
  geom_point(shape=24, color="black", fill="red", size=5) +
  theme_ipsum() +
...
### 여름극점최저기온
```{r}
avg_summer_pole_min <- (sum(as.numeric(summer$극점최저기온))/30)
summer %>%
  ggplot(aes(x=년도, y=극점최저기온, group=1)) +
  geom_line(color="red") +
  geom_point(shape=24, color="black", fill="red", size=5) +
  theme_ipsum() +
...
winter_df %>%
  ggplot(aes(x=년도, y=겨울평균기온, group=1)) +
...
winter_df %>%
  ggplot(aes(x=년도, y=겨울평균최고기온, group=1)) +
  geom_line(color="blue") +
  geom_point(shape=25, color="black", fill="blue", size=5) +
  theme_ipsum() +
...
### 겨울평균극점최고기온
```{r}
avg_winter_average_pole_max <- (sum(as.numeric(winter_df$겨울평균극점최고기온))/30)
winter_df %>%
  ggplot(aes(x=년도, y=겨울평균극점최고기온, group=1)) +
  geom_line(color="blue") +
  geom_point(shape=25, color="black", fill="blue", size=5) +
  theme_ipsum() +
...
winter_df %>%
  ggplot(aes(x=년도, y=겨울극점최고기온, group=1)) +
  geom_line(color="blue") +
  geom_point(shape=25, color="black", fill="blue", size=5) +
  theme_ipsum() +
...
winter_df %>%
  ggplot(aes(x=년도, y=겨울평균최저기온, group=1)) +
  geom_line(color="blue") +
  geom_point(shape=25, color="black", fill="blue", size=5) +
  theme_ipsum() +
...
### 겨울평균극점최저기온
```{r}
avg_winter_average_pole_min <- (sum(as.numeric(winter_df$겨울평균극점최저기온))/30)
winter_df %>%
  ggplot(aes(x=년도, y=겨울평균극점최저기온, group=1)) +
  geom_line(color="blue") +
  geom_point(shape=25, color="black", fill="blue", size=5) +
  theme_ipsum() +
  geom_hline(yintercept = avg_winter_average_pole_min, linetype = 2, color = "grey35", size = 1) +
  labs(title = "서울시 겨울(12월-2월) 평균극점최저기온",
       subtitle = "1998 - 2018",
       x = "년도", 
       y = "기온") + theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5 ))
```
...
winter_df %>%
  ggplot(aes(x=년도, y=겨울극점최저기온, group=1)) +
  geom_line(color="blue") +
  geom_point(shape=25, color="black", fill="blue", size=5) +
  theme_ipsum() +
